...
## Day 2 - Gift Shop
This one was really easy.  Nice break from the pain of Day 1's part 2.  I had to refactor part 2 to use `long` instead of `int` but other than that it was straight forward.
